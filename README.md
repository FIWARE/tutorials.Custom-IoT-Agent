...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?repo=FIWARE/tutorials.Custom-IoT-Agent&ref=NGSI-v2)
...
-   [Passing custom message formats](#passing-custom-message-formats)
    -   [The teaching goal of this tutorial](#the-teaching-goal-of-this-tutorial)
    -   [Reusing Common Functionality](#reusing-common-functionality)
